...
df = pd.read_csv('.csv') #usecols = head12
...
X1 = [ 	df.TIME_OF_RECORDING,	df.TILT_ANGLE,	df.INITIAL_VELOCITY,	df.FINAL_VELOCITY_ACCLERATION,	df.TILT_THRESHOLD(ANGLE/VELOCITY),		df.SPEED_LIMIT,	df.sudden_acceleration,	df.SUDDEN_STOP,	df.EXCESS_BIKE_TILT ]


X2 =  [ 	df2.TIME_OF_RECORDING,	df2.TILT_ANGLE,	df2.INITIAL_VELOCITY,	df2.FINAL_VELOCITY_ACCLERATION,	df2.TILT_THRESHOLD(ANGLE/VELOCITY),		df2.SPEED_LIMIT,	df2.sudden_acceleration,	df2.SUDDEN_STOP,	df2.EXCESS_BIKE_TILT ]
